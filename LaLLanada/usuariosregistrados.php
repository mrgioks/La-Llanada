...
if (!isset($_SESSION['rol_idrol'])) {
    ...
    $sentencia = $pdo->query("SELECT id_usuario,nombres,email,telefono,usuario FROM usuarios");
			...
			<div class="gtco-container">
				<div class="row">
					<div class="col-md-12 col-md-offset-0 text-center" style="margin-top:100px">
						<center><h1 style="color:#fff">Perfiles</h1></center>									
						<div class="table-responsive">
							<table class="table table-bordered table-hover">
								...
								<tbody>
									...
									?>
									<tr>
										<td style="color:#fff"><?php echo $dato->id_usuario; ?></td>
										<td style="color:#fff"><?php echo $dato->nombres; ?></td>
										<td style="color:#fff"><?php echo $dato->email; ?></td>
										<td style="color:#fff"><?php echo $dato->telefono; ?></td>
										<td style="color:#fff"><?php echo $dato->usuario; ?></td>
