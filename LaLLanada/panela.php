...
<html>
    ...
    <div class="card">
        <img class="card-img-top" src="images/panela1.jpeg" alt="Card image cap">
        <div class="card-body">
            <h5 class="card-title">Panela de un kg</h5>
    ...
    <div class="card">
        <img class="card-img-top" src="images/panela2.jpeg" alt="Card image cap">
        <div class="card-body">
            <h5 class="card-title">Panela de 833gr</h5>
    ...
    <div class="card">
        <img class="card-img-top" src="images/panela3.jpeg" alt="Card image cap">
        <div class="card-body">
            <h5 class="card-title">Panela en presentación coquito de un peso equivalente a 910 gramos </h5>
