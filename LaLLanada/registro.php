...
<head>
			...
			<div class="row">
				<div class="col-md-12 col-md-offset-0 text-left">
					...
					<div class="row row-mt-15em">
						...
						<div class="col-md-4 col-md-push-1 animate-box" data-animate-effect="fadeInRight" style="margin-top: -130px;">
							<div class="form-wrap">
								<div class="tab">
									...
									<div class="tab-content">
							            ...
							            <h3 class="cursive-font">Registro</h3>
											<form action="registro-guardar.php" method="POST">
										
											  <div class="row form-group">
											    <label for="pwd"> Nombres: </label>
												<input type="text" class="form-control" placeholder="Ingrese el nombre" name="nombres" required="">
											  </div>
														
											  <div class="row form-group">
												<label for="pwd"> E-mail: </label>
												<input type="text" class="form-control" placeholder="Ingrese el E-mail" name="email" required="">
											  </div>		
					
											  <div class="row form-group">
												<label for="uname"> Teléfono: </label>
												<input type="text" class="form-control" placeholder="Ingrese número de teléfono" name="telefono" required="">
											  </div>

                                              <div class="row form-group">
												<label for="pwd"> Usuario: </label>
												<input type="text" class="form-control" placeholder="Ingrese el usuario" name="usuario" required="">
											  </div>
                                              <input type="hidden" name="oculto" value="1">
											  <div class="row form-group">
												<label for="pwd"> Contraseña: </label>
												<input type="password" class="form-control" placeholder="Ingrese la contraseña" name="contrasena" required="">
											  </div>
											  </div>
	...
	<script src="js/main.js"></script>
      ...
      <!--?php
               ...
               $insertar= ("INSERT INTO usuarios(Nombre,Apellido,Telefono) Values ('$Nombre','$Apellido','$Telefono')");

               $resultado= ($conx,$insertar);
